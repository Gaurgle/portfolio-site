...
- Homepage opens on a loading screen: ROOS rises out of the black and resolves from a dispersed haze while the shaders compile, the fonts land, the islands hydrate, the scroll engine lays the stages out and the featured project pictures are decoded; then the sky, stars, navigation and stages fade in around it (first arrival per tab, reloads included; 1.6 to 5 s). The remaining pictures are warmed in the background once the world is in
